...
class student:
    ...
    def __init__(self, arifa, marks):  
        self.name                     #obj attr > class attr
        self.marks = marks                
        print("Adding new student in Database..")
        print(marks)

s1 = student(0,10)      # ae code tay bujhate cheyeche student nam na dileo by default anonymous hobe.
print(s1.name)
...
# ! data and related function k capsul banay.

# ? code:  encapsulation er kono code diye example dekhayni!!
